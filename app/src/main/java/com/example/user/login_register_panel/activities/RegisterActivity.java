package com.example.user.login_register_panel.activities;
...
import com.example.user.login_register_panel.R;
import com.example.user.login_register_panel.helpers.InputValidation;
import com.example.user.login_register_panel.modal.User;
import com.example.user.login_register_panel.sql.DatabaseHelper;
...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void postDataToSQLite() {
        ...
        if (!inputValidation.isInputEditTextFilled(textInputEditTextGender, textInputLayoutGender, getString(R.string.error_message_gender))) {
            return;
        }
