package com.example.user.login_register_panel.sql;
...
public class DatabaseHelper extends SQLiteOpenHelper {
   ...
   /* private String CREATE_USER_TABLE = "CREATE TABLE " + TABLE_USER + "("
    ...
    public List<User> getAllUser(){
         ...
         * SELECT user_id,user_name,user_age,user_gender,user_email,user_password FROM user ORDER BY user_name;
         */
    ...
    public boolean checkUser(String email){
         ...
         * Here query function is used to fetch records from user table this function works like we use sql query.
         * SQL query equivalent to this query function is
         * SELECT user_id FROM user WHERE user_email = 'kobirdotnet@gmail.com';
         */
        Cursor cursor = db.query(TABLE_USER, //Table to query
                columns,    //columns to return
    ...
    public boolean checkUser(String email, String password){
         ...
         * Here query function is used to fetch records from user table this function works like we use sql query.
         * SQL query equivalent to this query function is
         * SELECT user_id FROM user WHERE user_email = 'kobirdotnet@gmail.com' AND user_password = 'qwerty';
         */
        Cursor cursor = db.query(TABLE_USER,   //Table to query
                columns,   //columns to return
                selection,    //columns for the WHERE clause
